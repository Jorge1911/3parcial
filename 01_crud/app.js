  ...
  const guardarPost = async () => {
    ...
    if(respuesta!=null){
        Swal.fire({
            icon: 'success',
            title: 'EDITAR',
            text: 'OLEEE ES HORA DE FUMAR UN GALLO!!'
        })
    }else{
        Swal.fire({
            icon: 'error',
  ...
  const deletePost=async ()=>{
    ...
    if (respuesta != null) {
        Swal.fire({
            icon: 'success',
            title: 'ELIMINAR',
            text: 'SE ELIMINO CORRECTAMENTE COMPITA!!'
        })
    } else {
        Swal.fire({
            icon: 'error',
            title: 'ERROR',
            text: 'ALGO FALLO HERMANO!'
        })
  ...
  const addPost= async ()=>{
    ...
    if (respuesta != null) {
        Swal.fire({
            icon: 'success',
            title: 'INSERTAR',
            text:'SE INSERTO BIEN AHORA SAKA EL TOKEMON!'
        })
    } else {
        Swal.fire({
            icon: 'error',
            title: 'ERROR',
            text: 'FALTO QUE SACARAS LA MOTAAAA!'
        })
    }
